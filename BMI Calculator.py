...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="You have lower weighgt than normal body!")
...
Button(root,text="View Report",width=15,height=2,font="arial 10 bold",bg="#16fe68",fg="white",command=BMI).place(x=280,y=340)

label1=Label(root,font="arial 10 bold",bg="lightblue",fg="#fff")
